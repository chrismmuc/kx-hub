...
class TestGetRelatedClusters(unittest.TestCase):
    ...
    def test_get_related_clusters_no_centroid(self, mock_get_cluster):
        ...
        result = tools.get_related_clusters(
            cluster_id="cluster_without_centroid", limit=5
        )
    ...
    def test_get_related_clusters_distance_measures(
        self, mock_get_cluster, mock_get_db
    ):
